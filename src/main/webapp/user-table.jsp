...
<body>
		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse slimscrollsidebar">
				<ul class="nav" id="side-menu">
					...
					<li><a href="/crm_project_02/users" class="waves-effect"><i
					...
					<li><a href="/crm_project_02/task.html" class="waves-effect"><i
							class="fa fa-table fa-fw" aria-hidden="true"></i><span
			...
			<div class="container-fluid">
				<div class="row bg-title">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
						<a href="/crm_project_02/user-add" class="btn btn-sm btn-success">Thêm
							mới</a>
					</div>
					<!-- /.col-lg-12 -->
				</div>
	...
	<script type="text/javascript" src="js/user-table1.js"></script>
</body>
</html>